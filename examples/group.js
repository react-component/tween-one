...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rcQueueAnim = __webpack_require__(295);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _QueueAnim = __webpack_require__(296);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ticker2 = _rcTweenOne2["default"].ticker;
	
	var _utils = __webpack_require__(308);
	
	var _animTypes = __webpack_require__(309);
	...
	var QueueAnim = function (_React$Component) {
	  ...
	  QueueAnim.prototype.componentWillUnmount = function componentWillUnmount() {
	    ...
	    Object.keys(this.placeholderTimeoutIds).forEach(function (key) {
	      _ticker2.clear(_this3.placeholderTimeoutIds[key]);
	    });
	    this.keysToEnter = [];
	    this.keysToLeave = [];
	  };
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.performEnter = function (key, i) {
	    ...
	    _this5.placeholderTimeoutIds[key] = _ticker2.timeout(_this5.performEnterBegin.bind(_this5, key), interval * i + delay);
	  ...
	  this.performLeave = function (key) {
	    _ticker2.clear(_this5.placeholderTimeoutIds[key]);
